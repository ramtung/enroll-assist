...
public class weeklyScheduleTest {
    ...
    public void populate() {
        enrollmentListTestDataInitializer.populateListOfEnrollmentList(10);
    }
    ...
    @Test
    @Disabled
    void Given_repository_When_callWeeklySchedule_Then_checkPerformance() throws Exception {
        mvc.perform(get("/lists/weeklySchedules")
